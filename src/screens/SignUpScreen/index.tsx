...
import { authSignupAction } from '../../redux/action/AuthAction'
import { Colors } from '../../helper/Colors'
import CustomTextInput from '../../components/baseComponent/textInput'
import { styles } from './style'
import { AppDispatch } from '../../redux/store/Store'
import Button from '../../components/baseComponent/button/Index'
...
const LoginScreen = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      <LinearGradient 
      colors={[Colors.gradiant1, Colors.gradiant2, Colors.gradiant3]} 
