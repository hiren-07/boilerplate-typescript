import {
  ...
  const Textinput = (props) => {
    ...
    useEffect(() => {
      const showSubscription = Keyboard.addListener("keyboardDidShow", (e) => {
        if (
          ...
          props.refs.current.measureLayout(
            scrollRef.current,
            (left, top, width, height) => {
              scrollRef.current.scrollTo({ y: top - e.endCoordinates.height });
            }
          );
        }
      });
    ...
    useEffect(() => {
      if (isFocused && props.multiline) onFocus();
    }, [props.value]);
          ...
          style={
            props.textInputTabStyle
              ...
              : {
                  flexDirection: "row",
                  alignItems: "center",
                  width: props.skipMargin ? "auto" : "90%",
                  minHeight:
                    ScaleSize.spacing_extra_large *
                    (props.multiline ? 1.6 : 0.85),
                  maxHeight:
                    ScaleSize.spacing_extra_large *
                    (props.multiline ? 1.6 : 0.85),
                  ...
                  marginHorizontal: props.skipMargin
                    ? 0
                  ...
                  borderWidth: 2,
                  borderColor: isFocused ? Colors.primary : Colors.lightest_gray,
                  alignItems: "center",
                }
          }
        >
          {props.IconSource ? (
            <Image
              style={[
                styles.leftIcon,
                { tintColor: isFocused ? Colors.primary : Colors.light_gray },
              ]}
          ...
          <TextInput
            ...
            placeholderTextColor={isFocused ? Colors.primary : Colors.light_gray}
            style={[
          ...
          {props.isOptional && !props.value ? (
            <Text
              style={styles.jobLinkInputPlaceholder}
        ...
        {props.errorText ? (
          <View
            style={[
              ...
              {
                marginLeft: props.skipMargin
                  ? ScaleSize.spacing_small
                  : ScaleSize.spacing_small * 3,
              },
            ]}
          >
  ...
  const styles = StyleSheet.create({
    jobLinkInputPlaceholder: {
      fontSize: TextFontSize.small_text,
      fontFamily: AppFonts.semi_bold,
      position: "absolute",
      paddingTop: ScaleSize.spacing_very_small / 2,
    ...
    textInput: {
      ...
      alignItems: "center",
      alignSelf: "center",
      marginTop: ScaleSize.spacing_very_small / 1.5,
      fontSize: TextFontSize.small_text,
      paddingLeft: ScaleSize.spacing_small / 2,
      fontFamily: AppFonts.semi_bold,
    ...
    errorTextArea: {
      ...
      flexDirection: "row",
      marginLeft: ScaleSize.spacing_small * 3,
    ...
    optionalText: {
      position: "absolute",
      right: ScaleSize.small_image,
      top: ScaleSize.spacing_medium * 3,
      alignSelf: "center",
      textAlign: "center",
      textAlignVertical: "center",
      bottom: 0,
      fontSize: ScaleSize.small_text,
      fontFamily: AppFonts.medium_italic,
    },
  });